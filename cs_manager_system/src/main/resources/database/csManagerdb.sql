CREATE DATABASE IF NOT EXISTS csmanager;
...
CREATE TABLE IF NOT EXISTS factura (
  ...
  numeroDeCuotasDelVehiculo INTEGER(3),
  tiempoDeGarantia INTEGER(2) NOT null,
  costosAdicionalesDelVehiculo FLOAT,
  impuestosDelVehiculo FLOAT NOT NULL,
  vigenciaDelSeguroEnMeses INTEGER(2) DEFAULT 0,
